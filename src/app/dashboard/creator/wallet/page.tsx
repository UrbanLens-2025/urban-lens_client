...
export default function CreatorWalletPage() {
  ...
  const transactionVolume = useMemo(() => {
    const now = new Date();
    const data: Array<{ period: string; deposits: number; withdrawals: number }> = [];
  ...
  return (
    <PageContainer>
      ...
      <div className="grid gap-6 md:grid-cols-2">
        {/* Earnings Performance Chart - Left Column */}
        ...
        {/* Transaction Volume Chart - Right Column */}
        <Card className="border-2 border-primary/10 shadow-xl bg-card/80 backdrop-blur-sm">
          <CardHeader className="pb-4">
            <div className="flex items-center justify-between">
              <div>
          ...
          <CardContent>
            <div className="h-64">
              <ChartContainer config={transactionVolumeChartConfig} className="h-full w-full">
                <ResponsiveContainer width="100%" height="100%">
