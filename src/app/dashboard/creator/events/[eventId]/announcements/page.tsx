                  ...
                  {announcements.map((announcement) => (
                    ...
                    >
                      <TableCell className='flex items-start gap-3'>
                        ...
                        <div className='flex flex-col max-w-sm'>
                          ...
                          <p className='text-sm text-muted-foreground line-clamp-2'>
                            ...
                            1243412 3142 34 23 12344 132 142341 32 1234
                          </p>
                        </div>
                      </TableCell>
                      ...
                      <TableCell>
                        <Badge
                          variant={
                            announcement.isHidden ? 'secondary' : 'default'
                          }
                      ...
                      <TableCell className='text-right'>
                        <Button
                          ...
                          onClick={(e) => {
                            ...
                            router.push(
                              `/dashboard/creator/events/${eventId}/announcements/${announcement.id}/edit`
                            );
                          }}
                        >
