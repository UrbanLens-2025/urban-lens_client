...
export default function EditCreatorAnnouncementPage({
  params,
}: {
  ...
  const {
    ...
    isLoading,
    isError,
  } = useCreatorAnnouncementById(announcementId);
  const { mutate: updateAnnouncement, isPending: isUpdating } = useUpdateCreatorAnnouncement(
    announcementId,
    eventId
  );
    ...
    <div className="space-y-8">
      ...
      <Card className="border-border/60 shadow-sm">
        <CardHeader>
          ...
          <CardDescription>Update details and visibility for this event announcement.</CardDescription>
        </CardHeader>
        <CardContent>
          <Form {...form}>
                    ...
                    <FormItem className="flex flex-row items-center justify-between rounded-lg border p-4">
                      <div className="space-y-0.5">
                        ...
                        <p className="text-xs text-muted-foreground">
                          Hidden announcements will not appear to attendees.
                        </p>
                      </div>
                      <FormControl>
